...
DASHBOARD_DRIFT=$(rsync -ain --delete --exclude worldmap.jag "$SOURCE_ROOT/spectator/" "$RS_SDK_ROOT/spectator/")
STREAM_DRIFT=$(rsync -ain --delete "$SOURCE_ROOT/full-client-stream/" "$RS_SDK_ROOT/spikes/001-full-client-stream/")
